...
const PDFViewerApplication = {
  ...
  async run(config) {
    ...
    //BSK adding
    var extracss="";
    if( parseInt( params.get("download") ) ) extracss += " #download {display:none!important;}";
    if( parseInt( params.get("print") ) ) extracss += " #print {display:none!important;}";
    if( parseInt( params.get("freetext") ) ) extracss += " #editorFreeText {display:none!important;}";
    if( parseInt( params.get("ink") ) ) extracss += " #editorInk {display:none!important;}";
    if( parseInt( params.get("stamp") ) ) extracss += " #editorStamp {display:none!important;}";
    if( parseInt( params.get("docprop") ) ) extracss += " #documentProperties {display:none!important;}";
    if( parseInt( params.get("open") ) ) extracss += " #secondaryOpenFile {display:none !important;}";
    if( parseInt( params.get("toolbar") ) ) extracss += " #toolbarContainer {display:none !important;} #viewerContainer {top:8px !important;}";
    if( parseInt( params.get("textsel") ) ) extracss += " #cursorToolButtons {display:none !important;}";
    if( parseInt( params.get("mright") ) ) {
    ...
    if( extracss ) {
      var style=document.createElement("style");style.type="text/css";style.innerHTML=extracss;
...
function webViewerKeyDown(evt) {
  ...
  if (cmd === 1 || cmd === 8) {
    switch (evt.keyCode) {
      case 83:
        //BSK adding
        if( parseInt( params.get("download") ) ) { break; }
      ...
      case 79:
        //BSK adding
        if( parseInt( params.get("open") ) ) { break; }
        {
